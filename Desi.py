...
def login():
    os.system('clear')
    print logo
    print "\033[1;93m«-----------------\033[1;97mDisclaimer\033[1;93m---------------»"
        time.sleep(0.05)
        print "\033[1;42m       \033[1;34mThis Tool is Not for Educational Purpose   \033[1;0m"
        time.sleep(0.05)
        print "\033[1;43m\033[1;34mheld accountable. This Tool/Channel Doesn't    \033[1;0m"
        time.sleep(0.05)
        print "\033[1;44m\033[1;34mSupport illegal activities.For any illegal    \033[1;0m"
        time.sleep(0.05)
        print "\033[1;45m\033[1;34mActivities Contact me Via WhatsApp +923455453538\033[1;0m"
        time.sleep(0.05)
        print "\033[1;97m​██████████\033[1;92mREAL STAR SOMI\033[1;92m​██████████"
        time.sleep(0.05)
